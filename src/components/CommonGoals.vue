        ...
        <div class="page">
          ...
          <div v-if="this.$store.state.goals.length !== 0">
            <div v-for="goal in this.$store.state.goals" v-bind:key="goal.id">
                    ...
                    <div class="menu">
                      ...
                      <form v-on:submit="addKr(goal.id, $event)" class="createKR">
                        ...
                        <div class="meaning">
                          ...
                          <input id="createKrPercent" class="input_percent" type="number" min="1" max="100"
                                 placeholder="0"
                      ...
                      <form v-on:submit="addKr(goal.id, goal.remainderWeight, $event)" class="createKR">
                        <div class="flexModalCont">
                          ...
                          <div class="promptWeight" v-bind:class="{errorWeigth}">Осталось: {{ goal.remainderWeight }}
                          </div>
                          <div class="meaning">
                            <label for="createKrPercent">Вес</label>
                            <input v-bind:class="{errorWeigth}" id="createKrPercent" class="input_percent" type="number"
                                   min="1" max="100" placeholder="1" v-model="weight" required>
                            <span>%</span>
                          </div>
                        </div>
                        <div class="flexModalCont">
              ...
              <EditGoalModal v-if="showEditGoalModal" v-bind:idGoal="idSelectedGoal"
                             @close="showEditGoalModal = false"/>
              <DeleteGoalModal v-if="showDeleteGoalModal" @close="showDeleteGoalModal = false"
                               @delete="deleteGoal"/>
