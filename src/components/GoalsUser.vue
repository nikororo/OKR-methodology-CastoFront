    ...
    <div class="row no-gutter cont">
      ...
      <div class="col-md-5 col-lg-10 settings">
        ...
        <div class="header_targets_link">
          <router-link class="link_targets" active-class="active_link_targets" to="/planWeek">
            Планы на неделю
          </router-link>
          <router-link class="link_targets" active-class="active_link_targets" to="/goalsUser">
            Цели
          </router-link>
        </div>
        <div class="tasks">
