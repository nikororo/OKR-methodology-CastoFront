        ...
        <section class="addGoalModalBody">
          ...
          <div class="addGoalInput">
            ...
            <div class="addGoalDate">
              <input id="addGoalDateStart" class="input_user" placeholder="Дата начала" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" required>
              <input id="addGoalDateEnd" class="input_user" placeholder="Дата окончания" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" required>
            </div>
            ...
            <textarea  id="addGoalDescr" class="input_user" type="text" placeholder="Описание цели"></textarea>
          </div>
        </section>
        <footer>
          <button
